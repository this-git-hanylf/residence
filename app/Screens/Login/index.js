          ...
          <SafeAreaView>
            ...
            <View style={{marginTop: 20, marginLeft: 30}}>
              <Image
                ...
                source={require('@Asset/images/logo.png')}></Image>
            </View>

            {/* ---------- form input email dan password ---------- */}
            <View style={nbStyle.wrap}>
              <View>
                <Text style={nbStyle.title}>Login</Text>
              </View>
              ...
              <View
                ...
                <Icon
                  ...
                  active
                  name={this.state.isHidden ? 'eye-outline' : 'eye-off-outline'}
                  // type="Ionicons"
                  style={nbStyle.EyePasswordBtnIcon}></Icon>
              </View>
            </View>
            <View style={nbStyle.wrap}>
              <Button
