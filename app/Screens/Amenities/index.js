...
import { Text, TouchableOpacity, View, Image, Dimensions, FlatList, ScrollView, StatusBar } from 'react-native'
    ...
    renderItemMenu(item) {
        return (
            ...
            >
                ...
                <View>
                    <Image source={require('@Asset/icons/billing.png')} style={{ width: 40, height: 40, }} />
                </View>
                <Text>{item.menu}</Text>
    ...
    render() {
        return (
            <Container>
                ...
                <ScrollView>
                    <View style={{ flexDirection: 'row', flex: 1, width: '100%', flexWrap: 'wrap', justifyContent: 'center', marginTop: 20, alignItems: 'center' }}>
                        {this.state.menus.map((item, index) => (
                            ...
                            <TouchableOpacity key={index} style={{
                                ...
                                <View >
                                    <Image source={require('@Asset/icons/billing.png')} style={{ width: 40, height: 40, alignSelf: 'center' }} alt={item.images} />
